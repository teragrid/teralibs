...
func TestMatches(t *testing.T) {
	...
	testCases := []struct {
		...
		{"asura.owner.name CONTAINS 'Igor'", map[string]interface{}{"asura.owner.name": "Igor,Ivan"}, false, true},
		{"asura.owner.name CONTAINS 'Igor'", map[string]interface{}{"asura.owner.name": "Pavel,Ivan"}, false, false},
	}
